...
<%--    <p class="field"> <label for="name">  Username: </label> <br>--%>
...
<form method="post" action="/user">
    ...
    <div class="form-group">
        ...
        <input type="submit" class="btn btn-dark" name="buton" value="Log in">
    </div>
</form>
...
<p align="center">
    <%
        if(request.getAttribute("logare") != null){
            out.print(request.getAttribute("logare"));
        }
        else if(request.getAttribute("eroare") != null){
